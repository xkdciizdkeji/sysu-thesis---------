...
\sysusetup{
  title                = {基于并行计算及模块化优化的VLSI高效布局布线算法研究},% 论文标题（中文）
  % title*               = {Research on Efficient VLSI Placement and Routing Algorithm Based on Parallel Computing and Modular Optimization},% 论文标题（英文）
  title*               = {Parallel Computing and Modular Optimization Based VLSI Placement and Routing Algorithm Research},% 论文标题（英文）
  author               = {冯俊熙},
  author*              = {Junxi Feng},
  speciality           = {集成电路工程},
  speciality*          = {Integrated Circuit Engineering},
  supervisor           = {冯浪~副教授},
  supervisor*          = {Prof. Lang Feng},
  % practice-supervisor  = {XXX~教授, XXX~教授},
  % practice-supervisor* = {Prof. XXX, Prof. XXX},
  % date                 = {2017-05-01},  % 完成时间，默认为今日
  % professional-type    = {专业学位类型},
  % professional-type*   = {Professional degree type},
   department           = {集成电路学院},  % 院系，本科生需要填写
   student-id           = {23215413},  % 学号，本科生需要填写
